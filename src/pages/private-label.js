    ...
    render() {
        ...
        return (
            <div>
                ...
                <div id="main">
                <Hero img={pic03} title={'Mettiamo tutta la nostra competenza a vostra disposizione'} copy={`
                ...
                `}/>
                <Block img={pic01} title={'Competenza e qualità'} copy={`
                ...
                `}/>
                <Block img={pic02} title={'Il capitale umano'} copy={`
                   <p>
